...
const AssetTracker = (props: Props) => {
    ...
    return (
        <div className='lg:ms-[237px] mb-25 lg:mb-10 p-5 lg:w-[calc(100%-237px)]'>
            <div className="flex flex-row justify-between items-center">
                <div className="flex flex-col gap-4 items-start lg:flex-row justify-between lg:items-center w-full">
                    <div className="flex flex-row justify-between items-center gap-4">
                        <IoBagOutline color="#21c45d" className="bg-[#0d241f] lg:p-3 rounded-0-[8px] p-2 h-full !size-[40px] lg:!size-[50px]" />
                    ...
                    <div className="flex items-center justify-center gap-3">
                        <button className="bg-transparent border border-[#374151] rounded-0-[8px] px-2 lg:px-4 py-2 text-[14px]/[21px] tracking-[-0.56px] font-medium text-white hover:bg-[#28C76F] hover:bg-none transition cursor-pointer flex items-center capitalize" onClick={() => handleRefresh()} disabled={isPending}>
                            <RefreshCcw className={`inline-block me-2 ${isPending ? 'animate-spin' : ''}`} size={20} />
                            {
                                isPending ? 'refreshing...' : 'refresh'
                            }
                        </button>
                        <button className="bg-transparent border border-[#374151] rounded-0-[8px] px-2 lg:px-4 py-2 text-[14px]/[21px] tracking-[-0.56px] font-medium text-white hover:bg-[#28C76F] hover:bg-none transition cursor-pointer flex items-center capitalize" onClick={() => setIsAddAssetModalOpen(true)}>
                            <PlusIcon className="inline-block me-2" size={20} />
                            Add Asset
                        </button>
                        <button className="bg-[#811d1d] rounded-0-[8px] px-2 lg:px-4 py-2 text-[14px]/[21px] tracking-[-0.56px] font-medium text-white hover:bg-[#811d1d99] transition cursor-pointer flex items-center capitalize">
            ...
            <div className="mt-[58px] border border-[#374151] px-2 py-4 lg:p-5 flex flex-col rounded-0-sm w-full bg-[#161B22] gap-4">
            ...
            <div className="flex items-center justify-center rounded-0-sm bg-[#374151] p-[2px] mt-8 mb-5 w-fit">
