            ...
            <div className="h-[300px] w-full px-4">
                {
                        ...
                        <Bar 
                            data={{
                                ...
                                datasets: [
                                    {
                                    label: 'USDT Value',
                                    data: props.value.map((val) => val.toFixed(2)),
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'flex-end', gap: 4, height: '100%', justifyContent: 'center' }}>
                        <Skeleton variant="rectangular" width={'20%'} height={'40%'} sx={{bgcolor: '#374151'}} />
                        <Skeleton variant="rectangular" width={'20%'} height={'80%'} sx={{bgcolor: '#374151'}} />
                        <Skeleton variant="rectangular" width={'20%'} height={'50%'} sx={{bgcolor: '#374151'}} />
                        <Skeleton variant="rectangular" width={'20%'} height={'70%'} sx={{bgcolor: '#374151'}} />
                        <Skeleton variant="rectangular" width={'20%'} height={'30%'} sx={{bgcolor: '#374151'}} />
                    </Box>
                }
            </div>
        </div>
