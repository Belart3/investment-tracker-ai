                ...
                <div className="flex flex-col gap-1">
                    {
                        routes.map((routes, index) => {
                            ...
                            return (
                                <a key={index} href={routes.link} className={`flex items-center gap-[10px] rounded-sm py-2 px-3 ${isActive ? 'bg-[#28C76F] text-white hover:bg-[#22A85C]' : 'text-[#9CA3AF] hover:bg-[#374151]'} transition-colors`}>
